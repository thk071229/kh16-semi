...
<div class="container w-300">
	...
	<div class="cell center">
		<h1 style="color: var(--subtle);">아이디 찾기</h1>
	</div>
	<div class="cell">
	...
	<div class="cell">
		...
		<div class="flex align-center gap-5">
			<input type="text" name="memberEmail" class="search-input w-100" placeholder="example@email.com">
		</div>
	</div>
	...
	<div class="cell">
		<h3 class="warn">입력하신 정보에 대한 결과가 없습니다</h3>
	</div>
	</c:if>
