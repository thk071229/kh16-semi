...
<div class="container w-600">
        <form action="edit" method="post" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="cell">
                <textarea class="w-100" name="clubIntroduce" rows="5">${clubDto.clubIntroduce}</textarea>
            </div>
             ...
             <div class="cell">
	            ...
	            <div class="flex-box">
	                ...
	                <input class="input w-100 field address-input" type="text" name="regionName" value="${clubList.regionName}">
            ...
            <div class="cell">
                <button type="submit" class="btn btn-primary w-100 check-form">수정하기</button>
            </div>
