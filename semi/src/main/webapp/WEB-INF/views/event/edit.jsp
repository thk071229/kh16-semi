...
<div class="container w-600">
	...
	<form action="edit" method="post" autocomplete="off">
		...
		<div class="cell">
			<label>정모이름</label>
			<input type="text" class="field w-100" name="eventTitle" value="${eventDto.eventTitle}">
		</div>
		<div class="cell">
			<label>상세내용</label>
			<input type="text" class="field  w-100" name="eventContent" value="${eventDto.eventContent}">
		</div>
		<div class="cell">
			<label>정모일시</label>
			<input type="text" class="field w-100" name="eventDate" value="${eventDto.eventDate}">
		</div>
		...
		<div class="cell flex-box w-100">
			<input type="text" class="field w-50 center" name="eventRegionX" value="${eventDto.eventRegionX}" readonly style="border:0 solid white;">
			<input type="text" class="field w-50 center" name="eventRegionY" value="${eventDto.eventRegionY}" readonly style="border:0 solid white;">
		</div>
