...
<label class="board-logo">게시글 작성</label><br>
<label class="board-notice mt-10">커뮤니티 운영 수칙에 위반되는 글들은 동의없이 삭제될 수 있습니다</label>
</div>
<form action = "write" method = "post" autocomplete="off" class="check-form">
	...
	<br>
	<div class="mb-10">
	<input type = "text" name = "boardTitle" placeholder = "제목을 입력하세요" class="input w-100 mt-10">
	...
	<div class="success-feedback"></div>
    <div class="fail-feedback"></div>	
	<button type = "submit" class="btn btn-primary w-100 mt-10">등록</button>
</form>
</div>

<div class ="cell float-box">
  <a href="list?clubNo=${clubNo}" class="btn btn-common float-right">목록으로</a>
</div>
</div>
